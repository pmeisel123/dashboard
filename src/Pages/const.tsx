...
export const pages = [
	...
	},
	{
		...
		description: (
			<>
				Display Jira tickets with their estimates and allow selecting
				users to calculate the approximate completion date.
				<br />
	...
	},
	{
		...
		description: (
			<>
				...
				<br />
				Vacation times are pulled from src/assets/vacation.csv via
				src/API/vacations.tsx
				<br />
				Need to pull vacations from your HR site. Either via a cron job
				updating the csv file or by updating to vacations api to
